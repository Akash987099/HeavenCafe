        ...
        <div class="grid grid-cols-1 gap-5 lg:grid-cols-12">
            ...
            <aside class="lg:col-span-4 rounded-2xl border border-slate-200 bg-white shadow-sm lg:sticky lg:top-5 lg:h-[calc(100vh-3rem)] lg:max-h-[720px] flex flex-col">
                ...
                <form id="orderForm" method="POST" action="{{ route('customer-order.place') }}" class="border-t border-slate-100 p-5">
                    ...
                    <label class="mb-1 block text-xs font-semibold text-slate-600">Mobile number <span class="font-normal text-slate-400">(optional)</span></label><input name="customer_mobile" maxlength="20" value="{{ old('customer_mobile') }}" class="h-10 w-full rounded-lg border border-slate-200 px-3 text-sm outline-none focus:border-orange-500" placeholder="Enter mobile number">
                    <label class="mb-1 mt-3 block text-xs font-semibold text-slate-600">Email <span class="font-normal text-slate-400">(optional, for order confirmation)</span></label><input type="email" name="customer_email" maxlength="191" value="{{ old('customer_email') }}" class="h-10 w-full rounded-lg border border-slate-200 px-3 text-sm outline-none focus:border-orange-500" placeholder="you@example.com">
