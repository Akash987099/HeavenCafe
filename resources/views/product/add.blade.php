                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" min="0" step="1" class="form-control" id="store_qty" name="store_qty" value="{{ old('store_qty') }}" placeholder="Enter store quantity" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea type="text" class="form-control" id="short_description" name="short_description" placeholder="Enter Details" required></textarea>
                                </div>
                            </div>
